...
import org.opensplice.demo.{Coord2D, Shape2D, ColorRGB}
...
object BouncingRobot {
  ...
  def main(args: Array[String]) {
    ...
    def simulateAutoRobot(r: Robot): Unit = {
      shapeDW ! r
      shapeDW ! new Shape2D(sid, id+1, r.northWheel._2,r.northWheel._3, new Coord2D(r.northWheel._1.x, r.northWheel._1.y), wheelColor)
      shapeDW ! new Shape2D(sid, id+2, r.southWheel._2,r.southWheel._3, new Coord2D(r.southWheel._1.x, r.southWheel._1.y), wheelColor)
      shapeDW ! new Shape2D(sid, id+3, r.eastWheel._2,r.eastWheel._3, new Coord2D(r.eastWheel._1.x, r.eastWheel._1.y), wheelColor)
      shapeDW ! new Shape2D(sid, id+4, r.westWheel._2,r.westWheel._3, new Coord2D(r.westWheel._1.x, r.westWheel._1.y), wheelColor)
      contourDW ! new Shape2D(sid, id+5, r.region.width, r.region.height, new Coord2D(r.region.x0, r.region.y0), color)
